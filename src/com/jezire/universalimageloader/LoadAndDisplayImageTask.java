...
import com.jezire.universalimageloader.FailReason.FailType;
...
import com.jezire.universalimageloader.ImageScaleType;
...
import com.jezire.universalimageloader.ImageDecodingInfo;
import com.jezire.universalimageloader.ImageDownloader;
import com.jezire.universalimageloader.ImageDownloader.Scheme;
import com.jezire.universalimageloader.ImageAware;
import com.jezire.universalimageloader.IoUtils;
	...
	private Bitmap tryLoadBitmap() throws TaskCancelledException {
		...
		try {
			...
			if (bitmap == null || bitmap.getWidth() <= 0 || bitmap.getHeight() <= 0) {
				...
				String imageUriForDecoding = options.isCacheOnDisc() && tryCacheImageOnDisc(imageFile) ? cacheFileUri : uri;
